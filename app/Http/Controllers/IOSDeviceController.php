...
class IOSDeviceController extends Controller
{
    ...
    function confirmLoggedIn(){
        if(!(stripos($_SERVER['HTTP_USER_AGENT'],'1.2.3')===false) || !(stripos($_SERVER['HTTP_USER_AGENT'],'1.2.5')===false) || !(stripos($_SERVER['HTTP_USER_AGENT'],'1.2.5')===false) || !(stripos($_SERVER['HTTP_USER_AGENT'],'Nflsers-Android')===false)){
